...
SELECT department_id, AVG(SALARY), COUNT(*) AS total_func FROM employees
...
WHERE RIGHT(PHONE_NUMBER, 3) = 515;
...
SELECT EMPLOYEE_ID, FIRST_NAME, HIRE_DATE AS ano_contratacao FROM employees;


-- 14. Escreva uma query que exiba as seguintes informações de cada funcionário: id , primeiro nome e dia do mês no qual foi contratado (exiba somente o dia).
SELECT EMPLOYEE_ID, FIRST_NAME, RIGHT(HIRE_DATE, 2) AS dia_contratacao FROM employees;
