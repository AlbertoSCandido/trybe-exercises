...
function sendMarsTemperature(temp, onFail, time) {
  if (Math.random() <= 0.6) {
    setTimeout(()=> {
...
sendMarsTemperature(temperatureInFahrenheit, handleError, messageDelay);

// imprime "Hi there! Curiosity here. Right now is 53ºC at Mars", por exemplo, ou "Error getting temperature: Robot is busy"
sendMarsTemperature(greet, handleError, messageDelay);