...
USE betrybe_automoveis;
-- Crie um TRIGGER que, a cada nova inserção feita na tabela carros , defina o valor da coluna data_atualizacao para o momento do 
-- ocorrido, a acao para 'INSERÇÃO' e a coluna disponivel_em_estoque para 1 .
SELECT * FROM carros;
DELIMITER $$
...
-- Crie um TRIGGER que, a cada atualização feita na tabela carros , defina o valor da coluna data_atualizacao para o 
...
CREATE TRIGGER trigger_carro_delete
